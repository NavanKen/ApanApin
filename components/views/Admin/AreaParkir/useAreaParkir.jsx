...
const useAreaParkir = () => {
  ...
  const getAreaParkir = async () => {
    ...
    const res = await AreaParkisService.getAreaParkir(params);
    return res.data;
  };
  ...
  const {
    ...
    queryKey: ["AreaParkir", currentPage, currentLimit, currentSearch],
    queryFn: getAreaParkir,
