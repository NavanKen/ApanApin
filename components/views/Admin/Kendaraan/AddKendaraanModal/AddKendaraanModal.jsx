...
import useAddKendaraanModal from "./useAddKategoriModal";
import {
  Select,
  SelectContent,
  SelectItem,
...
const AddKendaraanModal = forwardRef(({ onSuccess }, ref) => {
  const {
    isOpen,
    handleOpenChange,
    form,
    ...
    handleClose,
    handleSubmit,
  } = useAddKendaraanModal({ onSuccess });
  ...
  return (
    <Modal open={isOpen} onOpenChange={handleOpenChange}>
      <ModalContent className="sm:max-w-lg" onClose={handleClose}>
        <ModalHeader>
          <ModalTitle>Tambah Kendaraan Baru</ModalTitle>
          <ModalDescription>
...
AddKendaraanModal.displayName = "AddKendaraanModal";

export default AddKendaraanModal;
